...
// Mẫu Vòm sâm. Tối thiểu 2,15 giây, chờ font + ảnh, tối đa 3 giây, chạm để bỏ qua. ?loader= để xem lại khi thử.
(() => {
  ...
  const MAU = {
    6: { min: 2150, anh: ['chum-sam-doc.webp'], html: `
      <div class="chao__in">
        <div class="k-wrap">
          <figure class="k-vom" style="margin:0"><div class="k-khung k6__khung"><img src="${IMG}chum-sam-doc.webp" width="620" height="763" alt=""></div></figure>
          ${hoi}
